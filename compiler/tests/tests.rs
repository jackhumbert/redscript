...
fn compile_string_interpolation() -> Result<(), Error> {
    ...
    let expected = vec![
        ...
        Instr::StringConst(PoolIndex::new(0)),
        Instr::Return,
        Instr::InvokeStatic(Offset::new(203), 0, PoolIndex::new(22), 3),
        Instr::AsRef(PoolIndex::new(7)),
        Instr::InvokeStatic(Offset::new(87), 0, PoolIndex::new(22), 2),
        Instr::AsRef(PoolIndex::new(7)),
        Instr::StringConst(PoolIndex::new(1)),
        Instr::AsRef(PoolIndex::new(7)),
        Instr::InvokeStatic(Offset::new(48), 0, PoolIndex::new(22), 0),
        Instr::AsRef(PoolIndex::new(7)),
        Instr::Local(PoolIndex::new(31)),
        Instr::AsRef(PoolIndex::new(7)),
        ...
        Instr::ParamEnd,
        Instr::AsRef(PoolIndex::new(7)),
        Instr::InvokeStatic(Offset::new(82), 0, PoolIndex::new(22), 1),
        Instr::AsRef(PoolIndex::new(7)),
        Instr::ToString(PoolIndex::new(8)),
